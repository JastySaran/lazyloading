...
//---------------**------**---------------------**-------------------**------------------**-----------**
        ...
        topRefreshControl?.attributedTitle = NSAttributedString(string: "Pull down to reload!")
        topRefreshControl?.addTarget(self, action: #selector(self.scrollTop), for: .valueChanged)
...
//---------------**------**---------------------**-------------------**------------------**-----------**
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell: UITableViewCell? = tableView.dequeueReusableCell(withIdentifier: "MyTableCell", for: indexPath)
